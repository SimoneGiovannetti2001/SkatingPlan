...
public class DEMOAtletaDAO implements AtletaDAO {
    ...
    static{
        atleti.add(new Atleta("Simone", "Giovannetti", "simo.giova@gmail.com", Ruolo.ATLETA, 1, "simone", Livello.AGONISMO));
        atleti.add(new Atleta("Damiano", "Renzi", "dami.renzi@gmail.com", Ruolo.ATLETA, 2, "damiano", Livello.PRIMI_PASSI));
        atleti.add(new Atleta("Filippo", "Fiore", "fili.fiore@gmail.com", Ruolo.ALLENATORE, 3, "filippo", Livello.AGONISMO));
        atleti.add(new Atleta("Alessia", "Filippi", "ale.fili@gmail.com", Ruolo.ALLENATORE, 4, "alessia", Livello.PREAGONISMO));
    }
