...
public class DEMOAtletaDAO implements AtletaDAO {
    ...
    static{
        atleti.add(new Atleta("Simone", "Giovannetti", "simo.giova@gmail.com", Role.ATLETA, 1, "simone", Livello.AGONISMO_AVANZATO));
        atleti.add(new Atleta("Damiano", "Renzi", "dami.renzi@gmail.com", Role.ATLETA, 2, "damiano", Livello.PRIMI_PASSI));
        atleti.add(new Atleta("Filippo", "Fiore", "fili.fiore@gmail.com", Role.ALLENATORE, 3, "filippo", Livello.AGONISMO_BASE));
        atleti.add(new Atleta("Alessia", "Filippi", "ale.fili@gmail.com", Role.ALLENATORE, 4, "alessia", Livello.PREAGONISMO_AVANZATO));
    }
